...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "sudipta555-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/sudipta"
  #   chef.validation_client_name = "sudipta-validator"
  #   chef.validation_key_path = ".chef/sudipta-validator.pem"
  # end
end
